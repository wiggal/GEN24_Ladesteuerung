...
class SymoGen24:
    ...
    def get_API(self):
        ...
        # Bessere Werte BAT_ENERGYACTIVE_LIFETIME, da Verluste zur AC_Wandlung und Batterieverlust bereits eingerechnet (Vermutung)
        API['Batterie_IN'] = int(data['Body']['Data']['16580608']['channels']['BAT_ENERGYACTIVE_LIFETIME_CHARGED_F64']/3600)
        API['Batterie_OUT'] = int(data['Body']['Data']['16580608']['channels']['BAT_ENERGYACTIVE_LIFETIME_DISCHARGED_F64']/3600)
        return(API)
