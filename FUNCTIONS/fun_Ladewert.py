...
def getEinspeiseGrenzeLadewert( aktuellerLadewert, aktuelleEinspeisung, aktuellePVProduktion, LadewertGrund ):
...
def getAC_KapaLadewert( aktuellerLadewert, aktuellePVProduktion, LadewertGrund ):
